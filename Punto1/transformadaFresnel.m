...
if options.zoom
    hMin = round(Ny/2) - round((Ny*dy/2)/(waveLength*z/(Ny*dy)));
    hMax = round(Ny/2) + round((Ny*dy/2)/(waveLength*z/(Ny*dy)));
    wMin = round(Nx/2) - round((Nx*dx/2)/(waveLength*z/(Nx*dx)));
    wMax = round(Nx/2) + round((Nx*dx/2)/(waveLength*z/(Nx*dx)));
